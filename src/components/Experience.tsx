          ...
          <ol className="mt-6 flex flex-col  gap-8">
            <li className="flex gap-4">
              ...
              <dl className="flex flex-auto flex-wrap gap-x-2">
                ...
                >
                  <time>2023-june</time> <span aria-hidden="true">—</span>{" "}
                  <time>Present</time>
                </dd>
              </dl>
            </li>
    ...
    <article className="group relative ">
      <ul className="space-y-2">
        <li className="flex  items-start gap-2 ">
          <Icon></Icon>
          Gained valuable insight into corporate operations and business
          methodologies, understanding key industry-specific business use cases.
        </li>
        <li className="flex  items-start gap-2 ">
          <Icon></Icon>
          Acquired practical knowledge of technical frameworks and software
          development processes integral to the company’s operational strategy.
        </li>
        <li className="flex  items-start gap-2 ">
          <Icon></Icon>
          Collaborated with cross-functional teams, gaining exposure to diverse
          perspectives and approaches in tackling business challenges.
        </li>
      </ul>

      <p className="relative z-10 mt-2 text-sm text-zinc-600 dark:text-zinc-400"></p>
    </article>
  );
};
const ExtraParaTwo = () => {
  return (
    <article className="group relative ">
      <ul className="space-y-2">
        <li className="flex  items-start gap-2 ">
          <Icon></Icon>
          Engineered robust backend microservices using Spring Boot, enhancing
          the seamless maintenance of internal technical products that serve as
          critical bridges to customer interactions.
        </li>
        <li className="flex  items-start gap-2 ">
          <Icon></Icon>
          Developed a comprehensive automation website tailored for the
          technical support staff, facilitating full operational capabilities
          through a unified digital platform.
        </li>
        <li className="flex  items-start gap-2 ">
          <Icon></Icon>
          Designed and implemented backend APIs with Express.js, significantly
          automating and streamlining the company’s internal workflows.
        </li>
        <li className="flex  items-start gap-2 ">
          <Icon></Icon>
          Achieved a 20% improvement in server CPU utilization and a 33%
          enhancement in database performance by refactoring legacy
          microservices, leading to increased system efficiency and reliability
        </li>
      </ul>
